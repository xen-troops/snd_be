...
public:
     ...
     */
    explicit AlsaPcm(SoundItf::StreamType type, const std::string& deviceName = "default");
    ~AlsaPcm();
     ...
     * @param cbk callback
     */
    void setProgressCbk(SoundItf::ProgressCbk cbk) override { mProgressCbk = cbk; }
...
private:
    ...
    void queryHwParamRate(snd_pcm_hw_params_t* hwParams, SoundItf::PcmParamRanges& req, SoundItf::PcmParamRanges& resp);
    void queryHwParamBuffer(snd_pcm_hw_params_t* hwParams, SoundItf::PcmParamRanges& req,
                            SoundItf::PcmParamRanges& resp);
    void queryHwParamChannels(snd_pcm_hw_params_t* hwParams, SoundItf::PcmParamRanges& req,
                              SoundItf::PcmParamRanges& resp);
    void queryHwParamPeriod(snd_pcm_hw_params_t* hwParams, SoundItf::PcmParamRanges& req,
                            SoundItf::PcmParamRanges& resp);
    void queryHwParamFormats(snd_pcm_hw_params_t* hwParams, SoundItf::PcmParamRanges& req,
                             SoundItf::PcmParamRanges& resp);
};
