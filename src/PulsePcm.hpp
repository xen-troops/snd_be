...
public:
    ...
    PulseProplist(const std::string& name, const std::string& value) : PulseProplist() { set(name, value); }
...
public:
    ...
    PulsePcm* createStream(SoundItf::StreamType type, const std::string& name, const std::string& propName = "",
                           const std::string& propValue = "", const std::string& deviceValue = "");
...
public:
     ...
     */
    PulsePcm(pa_threaded_mainloop* mainloop, pa_context* context, SoundItf::StreamType type, const std::string& name,
             const std::string& propName, const std::string& propValue, const std::string& deviceName = "");
